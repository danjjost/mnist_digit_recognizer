...
class TestRemoteEvaluationEpoch(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.network_evaluation_epoch = RemoteEvaluationEpoch(self.input_blob_client, self.output_blob_client, self.blob_poller)
